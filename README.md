...
Video Transcoding is copyright [Don Melton](http://donmelton.com/) and available under a [MIT license](https://github.com/lisamelton/video_transcoding/blob/master/LICENSE).
